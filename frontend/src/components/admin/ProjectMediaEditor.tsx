...
export default function ProjectMediaEditor({
  ...
  function handleSaveEdit() {
    ...
    updatedItems[editingIndex] = {
      ...
      // Always store as boolean so backend receives explicitly true or false
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <label className="text-sm font-medium text-white">Project Media</label>
      ...
      >
        ...
        {isProcessing ? (
          ...
          <>
            ...
            <p className="text-sm font-medium text-blue-300">Drop media here</p>
          </>
        ) : (
          <>
              ...
              <div className="flex flex-col gap-3">
                ...
                <label className="flex flex-col gap-1 text-sm text-neutral-300">
                  ...
                  <input
                    ...
                    placeholder="Screenshot of home page"
                  />
                </label>
                ...
                <label className="flex flex-col gap-1 text-sm text-neutral-300">
                  ...
                  <input
                    ...
                    className="rounded-md bg-neutral-900 px-3 py-2 border border-neutral-700 text-neutral-200 placeholder:text-neutral-500 focus:outline-none focus:border-neutral-500"
                    placeholder="Homepage layout with dark theme"
                  />
                </label>

                {/* PDF or general landscape orientation checkbox */}
